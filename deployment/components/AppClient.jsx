...
export default function AppClient() {
  ...
  function applyHighlights(nodeIds, edgeIds) {
    ...
    graphRef.current.linkOpacity(link => link.__highlighted ? 1 : 0.4)
    graphRef.current.linkDirectionalParticles(link => link.__highlighted ? 5 : 0)
    graphRef.current.linkDirectionalParticleWidth(link => link.__highlighted ? 2.5 : 0)
    // Force immediate re-render so highlight colours apply even after simulation cooled down
